...
class TestAttachments:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_path_params_list(self, client: EInvoiceAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `document_id` but received ''"):
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_add(self, client: EInvoiceAPI) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_add(self, client: EInvoiceAPI) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_add(self, client: EInvoiceAPI) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_path_params_add(self, client: EInvoiceAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `document_id` but received ''"):
...
class TestAsyncAttachments:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_path_params_list(self, async_client: AsyncEInvoiceAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `document_id` but received ''"):
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_add(self, async_client: AsyncEInvoiceAPI) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_add(self, async_client: AsyncEInvoiceAPI) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_add(self, async_client: AsyncEInvoiceAPI) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_path_params_add(self, async_client: AsyncEInvoiceAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `document_id` but received ''"):
